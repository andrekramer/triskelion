...
from multillm import run_comparison, run_critique
...
async def compare():
    ...
    if request.method == "POST":
        ...
        response_lines = await process_comparison(input_text, selected_comp)
...
async def critique():
    ...
    if request.method == "POST":
        ...
        if input_text is None or input_text.strip() == "" or \
